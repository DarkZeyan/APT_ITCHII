...
public class Tarjeta {
    ...
    private ArrayList<Movimiento> movimientosTarjeta;

    public Tarjeta(String numeroCuenta, String numeroTarjeta, double limiteCredito, Fecha fechaCreacion,
    ...
    public ArrayList<Movimiento> getMovimientosTarjeta() {
